...
<a href="{{ route('sb.offers.create') }}" id="btn-new-mdl-offer-modal" class="btn btn-primary btn-new-mdl-offer-modal">
    <i class="bx bx-book-add mr-1"></i>New Offer2
</a>
{{-- <a href="{{ route('sb.offers.create') }}" id="btn-new-mdl-offer-modal" class="btn btn-primary btn-new-mdl-offer-modal">
    <i class="bx bx-book-add mr-1">New Offer
