...
class OfferController extends BaseController
{
     ...
     * @return Response
     */
    public function store(Offer $offer, CreateOfferRequest $request)
    {
   ...
   /**
    ...
    //  * @return Response
    //  */
    public function update(Offer $offer, $id, UpdateOfferRequest $request)
    {
        /** @var Offer $offer */
        $offer = $offer->find($id);
    ...
    public function processBulkUpload(Offer $offer, Request $request){
